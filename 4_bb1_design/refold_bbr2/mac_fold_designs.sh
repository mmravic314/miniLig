...
#$ -S /bin/bash
#$ -l mem_free=1G
#$ -e /netapp/home/mmravic/miniLig/4_bb1_design/refold_bbr2/logs
#$ -j y
#$ -l arch=linux-x64
#$ -l netapp=1G
#$ -l h_rt=00:29:00
